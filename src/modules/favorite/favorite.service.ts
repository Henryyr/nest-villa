...
import { FavoriteWithProperty } from './interfaces/favorite-with-property.type';
import { FindAllOptions } from 'src/common/find-all-options';
import { FavoriteResponseDto } from './dto/favorite-response.dto';
import { Favorite } from '@prisma/client';
import { CacheService } from 'src/jobs/cache.service';
import { PubSubService } from 'src/jobs/pubsub.service';
...
export class FavoriteService {
  ...
  async getFavorite(userId: string, options: FindAllOptions = new FindAllOptions()): Promise<FavoriteResponseDto[]> {
