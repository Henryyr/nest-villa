...
import { IFavoriteRepository } from 'src/shared/interfaces/favorite-repository.interface';
import { FavoriteWithProperty } from 'src/shared/types/favorite-with-property.type';
...
import { PubSubService } from 'src/cache/redis/pubsub.service';
