...
CREATE TABLE "_PropertyFacilities" (
    ...
    CONSTRAINT "_PropertyFacilities_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "Villa" ADD CONSTRAINT "Villa_id_fkey" FOREIGN KEY ("id") REFERENCES "Property"("id") ON DELETE CASCADE ON UPDATE CASCADE;
